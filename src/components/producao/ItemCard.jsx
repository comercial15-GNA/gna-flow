...
export default function ItemCard({ 
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-200">
      <div className="p-4">
        {/* Header */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          ...
          {item.peso && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-slate-600">{item.peso} kg</span>
            </div>
          )}
          <div className="flex items-center gap-2 text-sm">
          ...
          {item.cliente && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-slate-600 truncate">{item.cliente}</span>
            </div>
          )}
        </div>
