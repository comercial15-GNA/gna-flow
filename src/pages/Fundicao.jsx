...
export default function Fundicao() {
  ...
  const confirmarRetorno = () => {
    ...
    movimentarItem(retornarItem, 'modelagem', justificativa);
  };
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800">Fundição</h1>
            <p className="text-slate-500">Itens em processo de fundição</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
            ...
            return (
              <div key={op.id} className="bg-white rounded-xl border-2 border-red-200 shadow-sm overflow-hidden">
                <button
                  ...
                  className="w-full bg-red-50 border-b border-red-200 p-4 hover:bg-red-100 transition-colors text-left"
                >
