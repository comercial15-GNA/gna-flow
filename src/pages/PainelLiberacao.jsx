...
export default function PainelLiberacao() {
  ...
  const { data: itens = [], isLoading } = useQuery({
    queryKey: ['itens-painel-liberacao'],
    queryFn: async () => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-500 to-emerald-700">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-500 to-emerald-700 p-6 text-white">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-5xl font-bold tracking-tight">LIBERAÇÃO</h1>
