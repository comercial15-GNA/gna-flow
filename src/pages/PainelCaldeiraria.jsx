...
import { Hammer, AlertTriangle, Calendar, Package, User } from 'lucide-react';
import { format, isBefore, startOfDay } from 'date-fns';
import { ptBR } from 'date-fns/locale';

export default function PainelCaldeiraria() {
  ...
  const { data: itens = [], isLoading } = useQuery({
    queryKey: ['itens-painel-caldeiraria'],
    queryFn: async () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="bg-slate-800 rounded-xl p-6 mb-6 border-b-4 border-amber-500">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">CALDEIRARIA</h1>
              <p className="text-amber-400 text-lg">Próximas 30 Ordens de Produção</p>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-4">
                        <div className="font-mono text-amber-400 font-bold text-lg">
                          {item.numero_op}
                        </div>
                      </td>
                      <td className="px-4 py-4">
