...
export default function PainelAcabamento() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-pink-500 to-pink-700">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-500 to-pink-700 p-6 text-white">
