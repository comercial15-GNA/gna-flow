...
import { AlertTriangle, PackageCheck, Clock, Package } from 'lucide-react';
import { format, isBefore, startOfDay } from 'date-fns';
import { ptBR } from 'date-fns/locale';

export default function PainelColeta() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="bg-slate-800 rounded-xl p-6 mb-6 border-b-4 border-purple-500">
          ...
          <table className="w-full">
            <thead className="bg-slate-700">
              <tr className="text-left text-slate-300 text-sm font-semibold uppercase tracking-wider">
                ...
                <th className="px-4 py-4">Peso Exp.</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-slate-300">
                        {item.peso_expedicao ? `${item.peso_expedicao} kg` : '-'}
                      </td>
                      <td className="px-4 py-4 text-slate-300">
