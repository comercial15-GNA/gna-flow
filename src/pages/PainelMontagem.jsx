...
export default function PainelMontagem() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      ...
      <div className="bg-slate-800 rounded-xl p-6 mb-6 border-b-4 border-violet-500">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-violet-500 rounded-xl flex items-center justify-center">
              <Layers className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">MONTAGEM</h1>
              <p className="text-violet-400 text-lg">Itens em Processo de Montagem</p>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-4">
                        <div className="font-mono text-violet-400 font-bold text-lg">
                          {item.numero_op}
                        </div>
                      </td>
                      <td className="px-4 py-4">
