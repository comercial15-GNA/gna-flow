...
export default function PainelExpedicao() {
  ...
  const { data: itens = [], isLoading } = useQuery({
    queryKey: ['itens-painel-expedicao'],
    queryFn: async () => {
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-teal-400 text-lg">Ordens de Produção</p>
              </div>
            </div>
          ...
          <table className="w-full">
            <thead className="bg-slate-700">
              <tr className="text-left text-slate-300 text-sm font-semibold uppercase tracking-wider">
                ...
                <th className="px-6 py-4 text-left font-bold">PESO EXP.</th>
        ...
        {itens.length === 0 && (
          <div className="text-center py-20">
            <Truck className="w-20 h-20 mx-auto mb-4 opacity-50" />
            <p className="text-2xl font-medium opacity-90">Nenhum item em expedição</p>
          </div>
        )}
      </div>
    </div>
